...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="insertBodyFirstFooter">
        <fo:static-content flow-name="first-body-footer">
            <fo:block xsl:use-attribute-sets="__body__odd__footer__copyright">
                <xsl:text>© </xsl:text><xsl:value-of select="$copyright"/><xsl:text> </xsl:text><xsl:value-of select="$copyryear"/>
                <fo:block><xsl:text>The products, solutions, and services described in this document may be subject to certain geographic limitations and restrictions in their use. 
</xsl:text></fo:block>
                <fo:block><fo:inline font-weight="600">Confidential &amp; Proprietary:</fo:inline><xsl:text> </xsl:text><xsl:text> Not to be disclosed to or used by any other person without the prior written consent of Optiva.</xsl:text></fo:block>
            </fo:block>
            <fo:block xsl:use-attribute-sets="__body__odd__footer__pagenum">
                <xsl:call-template name="getVariable">
            ...
            <fo:block xsl:use-attribute-sets="__body__odd__footer__border"></fo:block>
        </fo:static-content>
    </xsl:template>
        ...
        <fo:static-content flow-name="odd-toc-header">
            <fo:block xsl:use-attribute-sets="__toc__odd__header">
                <!--<xsl:call-template name="getVariable">
                    ...
                    <xsl:with-param name="params">
                        <prodname>
                            <xsl:value-of select="$productName"/><xsl:text> </xsl:text><xsl:value-of select="$productVersion"/><xsl:text> </xsl:text><xsl:value-of select="$bookTitle"/>
                        </prodname>
                        <heading>
                            <fo:inline xsl:use-attribute-sets="__body__odd__header__heading">
                                <fo:retrieve-marker retrieve-class-name="current-header"/>
    ...
    <xsl:template name="insertIndexEvenFooter">
        <fo:static-content flow-name="even-index-footer">
            <fo:block xsl:use-attribute-sets="__body__odd__footer__copyright">
                <xsl:text>I© </xsl:text><xsl:value-of select="$copyright"/><xsl:text> </xsl:text><xsl:value-of select="$copyryear"/>
                <fo:block><xsl:text>The products, solutions, and services described in this document may be subject to certain geographic limitations and restrictions in their use. 
</xsl:text></fo:block>
                <fo:block><fo:inline font-weight="600">Confidential &amp; Proprietary:</fo:inline><xsl:text> </xsl:text><xsl:text> Not to be disclosed to or used by any other person without the prior written consent of Optiva.</xsl:text></fo:block>
            </fo:block>
    ...
    <xsl:template name="insertPrefaceLastFooter">
        <fo:static-content flow-name="last-body-footer"><fo:block xsl:use-attribute-sets="__body__odd__footer__copyright">
            <xsl:text>© </xsl:text><xsl:value-of select="$copyright"/><xsl:text> </xsl:text><xsl:value-of select="$copyryear"/>
            <fo:block><xsl:text>The products, solutions, and services described in this document may be subject to certain geographic limitations and restrictions in their use. 
</xsl:text></fo:block>
            <fo:block><fo:inline font-weight="600">Confidential &amp; Proprietary:</fo:inline><xsl:text> </xsl:text><xsl:text> Not to be disclosed to or used by any other person without the prior written consent of Optiva.</xsl:text></fo:block>
    ...
    <xsl:template name="insertBackCoverOddFooter">
        <fo:static-content flow-name="odd-back-cover-footer"><fo:block xsl:use-attribute-sets="__body__odd__footer__copyright">
            <xsl:text>© </xsl:text><xsl:value-of select="$copyright"/><xsl:text> </xsl:text><xsl:value-of select="$copyryear"/>
            <fo:block><xsl:text>The products, solutions, and services described in this document may be subject to certain geographic limitations and restrictions in their use. 
</xsl:text></fo:block>
            <fo:block><fo:inline font-weight="600">Confidential &amp; Proprietary:</fo:inline><xsl:text> </xsl:text><xsl:text> Not to be disclosed to or used by any other person without the prior written consent of Optiva.</xsl:text></fo:block>
    ...
    <xsl:template name="insertBackCoverEvenFooter">
        <fo:static-content flow-name="even-back-cover-footer"><fo:block xsl:use-attribute-sets="__body__odd__footer__copyright">
            <xsl:text>© </xsl:text><xsl:value-of select="$copyright"/><xsl:text> </xsl:text><xsl:value-of select="$copyryear"/>
            <fo:block><xsl:text>The products, solutions, and services described in this document may be subject to certain geographic limitations and restrictions in their use. 
</xsl:text></fo:block>
            <fo:block><fo:inline font-weight="600">Confidential &amp; Proprietary:</fo:inline><xsl:text> </xsl:text><xsl:text> Not to be disclosed to or used by any other person without the prior written consent of Optiva.</xsl:text></fo:block>
    ...
    <xsl:template name="insertGlossaryEvenFooter">
        <fo:static-content flow-name="even-glossary-footer"><fo:block xsl:use-attribute-sets="__body__odd__footer__copyright">
            <xsl:text>© </xsl:text><xsl:value-of select="$copyright"/><xsl:text> </xsl:text><xsl:value-of select="$copyryear"/>
            <fo:block><xsl:text>The products, solutions, and services described in this document may be subject to certain geographic limitations and restrictions in their use. 
</xsl:text></fo:block>
            <fo:block><fo:inline font-weight="600">Confidential &amp; Proprietary:</fo:inline><xsl:text> </xsl:text><xsl:text> Not to be disclosed to or used by any other person without the prior written consent of Optiva.</xsl:text></fo:block>
