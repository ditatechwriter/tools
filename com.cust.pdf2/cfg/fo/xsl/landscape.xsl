...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="page-height-landscape">215.9mm</xsl:variable>
    <xsl:variable name="page-width-landscape">279.4mm</xsl:variable>
    <xsl:variable name="page-margin-landscape">25mm</xsl:variable>
