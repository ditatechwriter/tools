...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:attribute-set name="odd__header">
   ...
   <!-- <xsl:attribute name="border-bottom">1pt solid #4F81BD</xsl:attribute>-->
    <xsl:attribute name="margin-left">1.8cm</xsl:attribute>
  ...
  <xsl:attribute-set name="__body__odd__footer" use-attribute-sets="odd__footer">
    ...
    <!--<xsl:attribute name="margin-left">1.8cm</xsl:attribute>
    <xsl:attribute name="margin-right">1.8cm</xsl:attribute>
    <xsl:attribute name="padding-bottom">6mm</xsl:attribute>-->
    </xsl:attribute-set>
  ...
  <xsl:attribute-set name="__body__odd__footer__border">
    <xsl:attribute name="border-bottom">3mm solid #FFB52A</xsl:attribute>
  </xsl:attribute-set>
  ...
  <xsl:attribute-set name="__body__even__footer__copyright">
    <xsl:attribute name="text-align">left</xsl:attribute>
    <xsl:attribute name="padding-left">5%</xsl:attribute>
    <xsl:attribute name="font-weight">300</xsl:attribute>
    <xsl:attribute name="font-family">Ubuntu</xsl:attribute>
    <xsl:attribute name="font-size">8pt</xsl:attribute>
    <xsl:attribute name="color">black</xsl:attribute>
    ...
    <xsl:attribute-set name="__body__odd__header" use-attribute-sets="odd__header">
      <xsl:attribute name="background-image">url(Customization/OpenTopic/common/artwork/Optiva_Logo_sm.png)</xsl:attribute>
      <xsl:attribute name="background-repeat">no-repeat</xsl:attribute>
      <xsl:attribute name="background-position-horizontal">left</xsl:attribute>
      <xsl:attribute name="background-position-vertical">5mm</xsl:attribute>
      <xsl:attribute name="font-weight">600</xsl:attribute>
      <xsl:attribute name="font-family">sans-serif</xsl:attribute>
      <xsl:attribute name="color">#2c2599</xsl:attribute>
    </xsl:attribute-set>
  
  <xsl:attribute-set name="__body__odd__header__logo" use-attribute-sets="odd__header">
  ...
  <xsl:attribute-set name="__body__even__header__landscape" use-attribute-sets="even__header">
    <xsl:attribute name="background-image">url(Customization/OpenTopic/common/artwork/Optiva_Logo_sm.png)</xsl:attribute>
    <xsl:attribute name="background-repeat">no-repeat</xsl:attribute>
    <xsl:attribute name="background-position">right top</xsl:attribute>
    <xsl:attribute name="font-weight">600</xsl:attribute>
    <xsl:attribute name="font-family">sans-serif</xsl:attribute>
    <xsl:attribute name="color">#2c2599</xsl:attribute>
  </xsl:attribute-set>
  ...
  <xsl:attribute-set name="__toc__odd__header" use-attribute-sets="odd__header">
    <xsl:attribute name="background-image">url(Customization/OpenTopic/common/artwork/Optiva_Logo_sm.png)</xsl:attribute>
    <xsl:attribute name="background-repeat">no-repeat</xsl:attribute>
    <xsl:attribute name="background-position">0mm 5mm</xsl:attribute>
    <xsl:attribute name="font-weight">600</xsl:attribute>
    <xsl:attribute name="font-family">sans-serif</xsl:attribute>
    <xsl:attribute name="color">#2c2599</xsl:attribute>
    </xsl:attribute-set>
