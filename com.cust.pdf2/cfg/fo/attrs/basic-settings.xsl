...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:variable name="page-margin-outside-front">0mm</xsl:variable>
  <xsl:variable name="page-margin-inside-front">0mm</xsl:variable>
  <xsl:variable name="page-margin-top-front">0mm</xsl:variable>
  <xsl:variable name="page-margin-bottom-front">0mm</xsl:variable>
  ...
  <xsl:variable name="page-margin-bottom">40mm</xsl:variable>
